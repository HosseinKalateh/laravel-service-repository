    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb" >
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@Lang('words.edit_tag')</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">@Lang('words.edit_tag')</h5>
                        <div class="card-body">
                            @error('name')
                            <div>
                            ...
                            <form action="{{ route('admin.tag.update', $tag->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText3" type="text" class="form-control" name="name" value="{{ old('name', $tag->name) }}">
                                </div>
                                <button type="submit" class="btn btn-primary">@Lang('words.edit_tag')</button>
                            </form>
                        </div>
                    </div>
                </div>
