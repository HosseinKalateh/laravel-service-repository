    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb" >
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@Lang('words.edit_post')</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">@Lang('words.edit_post')</h5>
                        <div class="card-body">
                            @if ($errors->any())
                                <div>
                            ...
                            <form action="{{ route('admin.post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText1" type="text" class="form-control" name="title" value="{{ old('title', $post->title) }}">
                                </div>
                                <div class="form-group">
                                    <label for="inputText2" class="col-form-label">@Lang('words.description')</label>
                                    <textarea name="description" id="inputText2" class="form-control">{{ old('description', $post->description) }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset($post->image) }}" alt="image" width="100%" height="auto">
                                    <input id="inputFile" type="file" class="form-control mt-2" name="image">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <select multiple="multiple" id="my-select" name="tags_id[]">
                                                @if (isset($tags))
                                                    @foreach($tags as $tag)
                                                        <option value='{{ $tag->id }}' @if(in_array($tag->id, $postTags)) selected @endif>{{ $tag->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                ...
                                <button type="submit" class="btn btn-primary mt-3">@Lang('words.edit_post')</button>
                            </form>
                        </div>
                    </div>
                </div>
